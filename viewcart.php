            ...
            if($rescheck > 0) {
              while ($row = mysqli_fetch_assoc($res)) {
                  echo '<tr>';
                    ...
                    ?>
                    <td>
                      <a href="php/incr.php?incr=<?php echo $row['id']; ?>" class="btn btn-sm btn-success"><i class="fas fa-plus"></i></a>
                      <a href="php/incr.php?dcr=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning"><i class="fas fa-minus"></i></a>
                      <a href="php/crud.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" name="deleteloc"><i class="fas fa-trash"></i></a>
                    </td>
                    <?php
                  echo '</tr>';
                  $i=$i+1;
